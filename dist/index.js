...
program
    ...
    .option("--verification-method <method>", "GSC verification method: meta, file, dns, gtm, analytics (default: meta)", "meta")
...
program
    ...
    .argument("<domain>", "Domain (e.g. example.com)")
    .option("--method <method>", "Verification method: meta, file, dns, gtm, analytics (default: meta or last-used)")
    .option("--json", "Output results as JSON")
