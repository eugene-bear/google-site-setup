...
export const ALL_PLATFORMS: ConversionPlatform[] = [
  "ads",
  "meta",
  "clarity",
  "linkedin",
...
export function getConversionTag(
  platform: ConversionPlatform
): ConversionTagDefinition {
  switch (platform) {
    case "ads":
      return {
        name: "Google Ads Conversion - PAUSED",
        notes:
          "Paused stub created by google-site-setup. Replace __CONVERSION_ID__ and __CONVERSION_LABEL__, attach a trigger, and unpause.",
        body: {
          name: "Google Ads Conversion - PAUSED",
          type: "awct",
          paused: true,
          firingTriggerId: [],
          notes:
            "Paused stub. Replace __CONVERSION_ID__ and __CONVERSION_LABEL__ with real values from Google Ads.",
          parameter: [
    ...
    case "meta":
      return {
        ...
        notes:
          "Paused stub. Replace __PIXEL_ID__ with your real Meta pixel ID, attach an All Pages trigger, and unpause.",
        body: {
          name: "Meta Pixel - PAUSED",
          type: "html",
          paused: true,
    ...
    case "clarity":
      return {
        ...
        notes:
          "Paused stub. Replace __CLARITY_ID__ with your Clarity project ID, attach an All Pages trigger, and unpause.",
        body: {
          name: "Microsoft Clarity - PAUSED",
          type: "html",
          paused: true,
    ...
    case "linkedin":
      return {
        ...
        notes:
          "Paused stub. Replace __PARTNER_ID__ with your LinkedIn partner ID, attach an All Pages trigger, and unpause.",
        body: {
          name: "LinkedIn Insight Tag - PAUSED",
          type: "html",
          paused: true,
